...
@section('title', 'Responsável Técnico por Atividade')
@section('page-title', 'Atividades com Responsável Técnico Obrigatório')
...
<div class="space-y-6">
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
        <div class="flex items-start">
            ...
            <div class="flex-1">
                <h3 class="text-sm font-semibold text-blue-800 mb-1">Responsável Técnico Obrigatório</h3>
                <p class="text-sm text-blue-700">
                    Configure quais atividades econômicas (CNAEs) exigem responsável técnico cadastrado para abertura e continuidade dos processos.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('admin.configuracoes.responsaveis-tecnicos.create') }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form method="GET" action="{{ route('admin.configuracoes.responsaveis-tecnicos.index') }}" class="flex flex-wrap items-center gap-4">
            ...
            <a href="{{ route('admin.configuracoes.responsaveis-tecnicos.index') }}" class="px-4 py-2 text-gray-600 hover:text-gray-800 text-sm">
                Limpar
            </a>
            @endif
        </form>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Cadastrado em</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $atividade->created_at->format('d/m/Y H:i') }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <form action="{{ route('admin.configuracoes.responsaveis-tecnicos.toggle', $atividade) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit"
                                ...
                                <a href="{{ route('admin.configuracoes.responsaveis-tecnicos.edit', $atividade) }}"
                                   class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                                   title="Editar">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                </a>

                                <form action="{{ route('admin.configuracoes.responsaveis-tecnicos.destroy', $atividade) }}"
                                      method="POST"
                                      class="inline"
        ...
        <div class="text-center py-12">
            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2"/></svg>
            <h3 class="mt-2 text-sm font-semibold text-gray-900">Nenhuma atividade cadastrada</h3>
            <p class="mt-1 text-sm text-gray-500">Comece adicionando atividades que exigem responsável técnico.</p>
            <div class="mt-6">
                <a href="{{ route('admin.configuracoes.responsaveis-tecnicos.create') }}"
