...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        @endif
          ...
          {{-- Relatório: Documentos por Servidor (apenas Admin/Gestor) --}}
          @if(auth('interno')->user()->isAdmin() || auth('interno')->user()->isGestor())
          <a href="{{ route('admin.relatorios.documentos-por-servidor') }}"
              class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 hover:shadow-md hover:border-red-300 transition-all group">
            <div class="flex items-start gap-3">
                <div class="p-2 bg-red-100 rounded-lg group-hover:bg-red-200 transition-colors flex-shrink-0">
                    <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                </div>
                <div class="flex-1 min-w-0">
                    <h3 class="text-base font-semibold text-gray-900 group-hover:text-red-600 transition-colors">
                        Documentos por Servidor
                    </h3>
                    <p class="text-xs text-gray-500 mt-1">
                        Prazos, atrasos e pendências por servidor
                    </p>
