<div class="space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $mediaGeralNotas !== null ? number_format($mediaGeralNotas, 1, ',', '.') : '-' }}</p>
                    <p class="text-xs text-gray-500">Média Geral das Notas</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <form method="GET" action="{{ route('admin.relatorios.pesquisa-satisfacao') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
            <input type="hidden" name="aba" value="pesquisas">
            <div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-200">
                        ...
                        <th class="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Média</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-center">
                            @if($resposta->media_notas !== null)
                                <span class="inline-flex items-center justify-center min-w-14 px-2 py-0.5 rounded-full text-xs font-semibold bg-amber-100 text-amber-800">
                                    {{ number_format($resposta->media_notas, 1, ',', '.') }} / 5
                                </span>
                            @else
