...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-xs text-gray-500">Use tipo, status, município e período</span>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="px-4 py-8 text-center text-sm text-gray-500">Nenhum processo encontrado para os filtros informados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
