...
<div class="max-w-8xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" x-data="criarAtividade()">
...
function criarAtividade() {
    return {
        inputCnae: '{{ old('codigo_cnae') }}',
        codigoCnae: '{{ old('codigo_cnae') }}',
        descricaoCnae: '',
        nome: '{{ old('nome') }}',
        buscando: false,
        erro: '',
        ...
        init() {
            // Se já tem CNAE (old input), busca a descrição
            if (this.codigoCnae) {
