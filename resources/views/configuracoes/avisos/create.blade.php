...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.configuracoes.avisos.store') }}" method="POST" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        @csrf
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="tipo" value="info" {{ old('tipo', 'info') === 'info' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="tipo" value="aviso" {{ old('tipo') === 'aviso' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="tipo" value="urgente" {{ old('tipo') === 'urgente' ? 'checked' : '' }}
