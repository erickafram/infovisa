...
@section('page-title', 'Tipos de Serviço')
...
<div class="max-w-8xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <p class="text-sm text-gray-600">Cadastre os tipos de serviço (Ex: Serviço de Alimentação, Serviço de Saúde)</p>
        </div>
        <a href="{{ route('admin.configuracoes.tipos-servico.create') }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" class="flex flex-wrap gap-4">
            ...
            <a href="{{ route('admin.configuracoes.tipos-servico.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:text-gray-800">
                Limpar
            </a>
            @endif
        </form>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-gray-500">Nenhum tipo de serviço encontrado</p>
        </div>
        @else
        <table class="w-full">
