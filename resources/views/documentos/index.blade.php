                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    @if($documento->sigiloso)
                                        <span class="text-xs bg-red-100 text-red-800 px-2 py-1 rounded">Sigiloso</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($documento->processo)
                                        <a href="{{ route('admin.estabelecimentos.processos.show', [$documento->processo->estabelecimento_id, $documento->processo->id]) }}#documentos" 
                                           class="inline-flex items-center text-sm text-blue-600 hover:text-blue-800 font-medium hover:underline transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($documento->data_vencimento)
                                        ...
                                        <div class="flex flex-col gap-1">
                                            <span class="inline-flex items-center px-2 py-1 {{ $classeBadge }} border rounded-full text-xs font-medium whitespace-nowrap">
                                    ...
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @if($minhaAssinatura && $minhaAssinatura->status === 'pendente' && $documento->status === 'aguardando_assinatura')
                                            <a href="{{ route('admin.assinatura.assinar', $documento->id) }}" 
                                               class="inline-flex items-center px-3 py-2 text-xs font-medium text-white bg-yellow-600 rounded hover:bg-yellow-700 transition">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        @if($documento->status === 'rascunho' && $documento->usuario_criador_id === auth('interno')->id())
                                            <a href="{{ route('admin.documentos.edit', $documento->id) }}" 
                                               class="inline-flex items-center px-3 py-2 text-xs font-medium text-white bg-gray-600 rounded hover:bg-gray-700 transition">
                                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                                </svg>
                                                Editar
                                        ...
                                        <a href="{{ route('admin.documentos.show', $documento->id) }}" 
                                           class="inline-flex items-center px-3 py-2 text-xs font-medium text-blue-600 bg-blue-50 rounded hover:bg-blue-100 transition">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
