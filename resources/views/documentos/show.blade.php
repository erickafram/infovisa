        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h1 class="text-3xl font-bold mb-2">{{ $documento->nome ?? $documento->tipoDocumento->nome }}</h1>
                        <p class="text-blue-100 text-lg">{{ $documento->numero_documento }}</p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @if($documento->processo)
                        <div>
                            ...
                            <p class="text-gray-900 font-medium">{{ $documento->processo->numero_processo }}</p>
                            <p class="text-sm text-gray-600">{{ $documento->processo->estabelecimento->nome_fantasia ?? $documento->processo->estabelecimento->razao_social }}</p>
                        </div>
                    @endif
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $documento->tipoDocumento->nome }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $documento->usuarioCriador->nome }}</p>
                        <p class="text-sm text-gray-600">{{ $documento->created_at->format('d/m/Y H:i') }}</p>
                    </div>
                        ...
                        @foreach($documento->assinaturas as $assinatura)
                            <div class="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900">{{ $assinatura->usuarioInterno->nome }}</p>
                                        <p class="text-sm text-gray-600">{{ $assinatura->usuarioInterno->cargo ?? 'Cargo não informado' }}</p>
                                    </div>
                                </div>
                                <div>
