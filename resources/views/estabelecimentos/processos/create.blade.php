        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            @if($tiposProcesso->isEmpty())
                <div class="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
                    Nenhum tipo de processo está disponível para este estabelecimento com a competência atual.
                </div>
            @else
                    ...
                    <label class="relative flex items-start p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors has-[:checked]:border-blue-500 has-[:checked]:bg-blue-50">
                        ...
                        <div class="flex items-center gap-3 w-full">
                            ...
                            <div class="flex-1">
                                ...
                                @if($tipo->descricao)
                                    <p class="mt-1 text-sm text-gray-500">{{ $tipo->descricao }}</p>
                                @endif
                            </div>
                        </div>
                    </label>
