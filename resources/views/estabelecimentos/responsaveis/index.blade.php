...
<div class="max-w-8xl mx-auto">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Responsáveis do Estabelecimento</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('admin.estabelecimentos.responsaveis.create', [$estabelecimento->id, 'legal']) }}"
            ...
            @if($estabelecimento->responsaveisLegais->count() > 0)
                <div class="space-y-3">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('admin.estabelecimentos.responsaveis.create', [$estabelecimento->id, 'tecnico']) }}"
            ...
            @if($estabelecimento->responsaveisTecnicos->count() > 0)
                <div class="space-y-3">
