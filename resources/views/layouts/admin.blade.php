            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3" :class="!showLabels() ? 'lg:px-2' : ''">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.pesquisas-satisfacao.respostas.index') }}" 
                       ...
                       class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.pesquisas-satisfacao.respostas.*') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                       :class="!showLabels() ? 'lg:justify-center' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
