...
<div class="container mt-5">
    <div class="alert alert-info" role="alert">
        <strong>Atenção!</strong> Basta inserir o CNPJ do estabelecimento e uma API fará a busca automática dos dados. Se o estabelecimento já estiver cadastrado, entre em contato com a Vigilância Sanitária Municipal.
    </div>
