            ...
            <div class="card-body">
                <form id="documento-form" method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="sigiloso" name="sigiloso">
                            <option value="0" <?php echo $arquivo['sigiloso'] == 0 ? 'selected' : ''; ?>>Não</option>
                            <option value="1" <?php echo $arquivo['sigiloso'] == 1 ? 'selected' : ''; ?>>Sim</option>
                        </select>
                    </div>
